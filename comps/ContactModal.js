...
const Stroke = styled(motion.div)`
   ...
   background: linear-gradient(
      109.11deg,
      ${(props) => props.modalStrokeOuter} 0%,
      ${(props) => props.modalStrokeInner} 51.68%,
      ${(props) => props.modalStrokeOuter2} 100.23%
   );
   border-radius: 16px;
`;
...
const Container = styled.form`
   ...
   background: linear-gradient(
      152.97deg,
      ${(props) => props.modalFill1} 0%,
      ${(props) => props.modalFill2} 100%
   );
...
const Input = styled.input`
   ...
   -webkit-autofill:active {
      ...
      box-shadow: inset 4px 0px 4px rgba(0, 0, 0, 0.6),
         inset 0px 6px 4px rgba(0, 0, 0, 0.6);
   }
   ...
   return (
      ...
      >
         ...
         >
            ...
            <p>
               Email form currently not working, please email me at
