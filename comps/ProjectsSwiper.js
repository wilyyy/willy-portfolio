            ...
            >
                <ProjectCont>
                    ...
                    <Info width="50%" height="560px">
                        <Column width="100%" height="60px">
                            ...
                            <Text H2><b>Role:</b> Full Stack Developer</Text>
                        </Column>
                        <Text Para>An all in one native mobile application for Translink's Compass Card system.</Text>
                ...
                <ProjectCont>
                    <ProjectsInfo 
                        ...
                        height="260px"
                    />
                    <Info width="45%" height="630px">
                        <Column width="100%" height="60px">
                            <Text H1>Scout - In Development</Text>
                            <Text H2><b>Role:</b> Project Manager, Full Stack Developer</Text>
                        </Column>
                        <Text Para>An anime database using machine learning to recommend anime to users based on their behaviour</Text>
                        <Column width="100%" height="150px">
                            <Text H2><b>Stack:</b></Text>
                            <StackCont 
                                border={theme === 'dark' ? '#2F323D' : '#000'}
